-- Football Duel — tek seferde cloud kurulum (0001..0012 + seed)
...
grant execute on function public.confirm_selection(uuid, uuid, uuid)
  to anon, authenticated;
-- ============================================================================
-- 0010 — Easy difficulty prefers well-known teams (prominence + is_popular).
-- ============================================================================
...
-- Both sides must be within the tier; hard has no cap. Selection stays random.
-- ============================================================================
...
$$;
-- ============================================================================
-- 0012 — Difficulty by REAL fame (curated), not a derived player count.
-- Anything not on the curated list gets rank 9999 -> only appears in HARD.
-- ============================================================================
